...
getContentPane().animateLayout(250);
   ...
   public Listprojections(Resources res) {
       super("Projections: ", BoxLayout.y());
    ...
    private void addButton(Projection a) {
      ...
      String url="file:/xampp/htdocs/webintegration/public/uploads/images";
       ...
       current=this;
       Button btnreservation=new Button("Reserver!");
          btnreservation.addActionListener(e->new Reservation(current).show());
        createLineSeparator();
        add(BoxLayout.encloseY(ta1,ta2,imgv,btnreservation));
        }
