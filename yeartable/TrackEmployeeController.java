...
public class TrackEmployeeController implements Initializable {
                        ...
                        if (item == null || empty) {
                            ...
                            if (datesArray.contains(item)) {
                                ...
                                if (getIndex() == (Integer.parseInt(month[indexx])-1 )) {
                                    ...
                                    }else if (status1.equals("Educationnel")) {
                                        setTextFill(Color.BLACK);
                                        setTextFill(Color.BLACK);
                                        String red = "250";
                                        String green = "128";
                                    ...
                                    else if (status1.equals("Blockbuster")) {
                                        String red = " 235";
                                        String green = "152";
                                        String blue = "78";
                                        System.out.println("Color; " + red + green + blue);
    ...
    @FXML
    private void ajoutCal(ActionEvent event) throws IOException {
       Stage stage = new Stage();
       Parent root = FXMLLoader.load(getClass().getResource("/projetjava/FXMLDocument.fxml"));
